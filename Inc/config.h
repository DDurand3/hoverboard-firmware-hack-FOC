...
#define BAT_CALIB_REAL_VOLTAGE  3920      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
...
#define N_MOT_MAX       3400            // [rpm] Maximum motor speed limit
